...
export function AppSidebar({
  ...
  const customerNav: NavGroup[] = [
    {
      label: "OVERVIEW",
      items: [{ id: "dashboard", label: "My Memberships", icon: BadgeCheck }],
    },
    {
      label: "ACTIVITY",
      items: [{ id: "history", label: "Activity History", icon: History }],
    },
    {
      label: "ACCOUNT",
      ...
      <Sidebar collapsible="icon">
        ...
        <SidebarContent>
          {navGroups.map((group, i) => (
            <SidebarGroup key={i}>
              <SidebarGroupLabel className="text-[10px] tracking-wider text-muted font-bold uppercase">
                {group.label}
              </SidebarGroupLabel>
              <SidebarGroupContent>
                <SidebarMenu>
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                className="text-muted hover:text-red-500 hover:bg-red-500/10 transition-colors h-9"
              >
